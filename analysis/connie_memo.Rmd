...
We pulled the race, income and poverty data points for U.S. ZIP Codes and counties from the U.S. Census American Community Survey product for 2017, the most recent available year via the Tidycensus package. To see the code that loads and cleans the data, click "Code" to expand. 
