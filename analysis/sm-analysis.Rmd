...
## Visualize Current ZIP Code Negative Equity Rate
...
```
# Map it, son
#m <- mapview(underwater_zips_2019_x, 
        cex = "pct_homes_negative_equity", 
        zcol= "pct_homes_negative_equity",
        col.regions = viridisLite::inferno,
        at = seq(10, 27, 5))
        ) %>%   
  addProviderTiles(providers$Stamen.Toner) %>% 
  # addCircleMarkers(data = underwater_zips_2019_x) %>%
  addHomeButton(extent(50, 50, 100, 100), "home")
m
qpal <- colorQuantile(, underwater_zips_2019_x$pct_homes_negative_equity, n = 3)

pal <- colorNumeric(
  palette = "magma",
  domain = underwater_zips_2019_x$pct_homes_negative_equity)
